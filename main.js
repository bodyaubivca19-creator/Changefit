    ...
    var t = {
                ...
                var z = e.frame = (s = h.requestAnimationFrame || h.webkitRequestAnimationFrame || h.mozRequestAnimationFrame || h.oRequestAnimationFrame || h.msRequestAnimationFrame) && C.bind ? s.bind(h) : function(t) {
                  ...
                  , S = l(function(t) {
                    ...
                    t.convert = function(t, e) {
                        if ("auto" == t && this.auto)
                            return t;
                        var n, r, o = "number" == typeof t, s = "string" == typeof t;
                        switch (e) {
                        case w:
                            if (o)
                                return t;
                        ...
                        case g:
                            if (s) {
                                ...
                                if (e.test(t))
                                    return "#" == t.charAt(0) && 7 == t.length ? t : ((n = /rgba?\((\d+),\s*(\d+),\s*(\d+)/.exec(t)) ? i(n[1], n[2], n[3]) : t).replace(/#(\w)(\w)(\w)$/, "#$1$1$2$2$3$3")
                            }
                            r = "hex or rgb string";
                            break;
                        case b:
                        ...
                        return a("Type warning: Expected: [" + r + "] Got: [" + typeof t + "] " + t),
                        t
                    }
                    ,
                    t.redraw = function() {
                  ...
                  , j = l(function(e) {
                    ...
                    e.stop = function() {
                        ...
                        (n = t.inArray(this, u)) >= 0 && (e = u.slice(n + 1),
                        u.length = n,
                    ...
                    e.render = function(t) {
                        ...
                        if (n < this.duration) {
                            ...
                            o = this.endRGB,
                            i(r[0] + a * (o[0] - r[0]), r[1] + a * (o[1] - r[1]), r[2] + a * (o[2] - r[2]))) : Math.round((this.begin + a * this.change) * c) / c,
        ...
        461: function(t, e, n) {
            ...
            i.define("brand", t.exports = function(t) {
                ...
                return n.ready = function() {
                    var n, i, a, f = o.attr("data-wf-status"), h = o.attr("data-wf-domain") || "";
                    /\.webflow\.io$/i.test(h) && s.hostname !== h && (f = !0),
                    f && !u && (e = e || (n = t('<a class="w-webflow-badge"></a>').attr("href", "https://webflow.com?utm_campaign=brandjs"),
                    i = t("<img>").attr("src", "https://d3e54v103j8qbb.cloudfront.net/img/webflow-badge-icon-d2.89e12c322e.svg").attr("alt", "").css({
                        marginRight: "4px",
                        width: "26px"
                    }),
                    a = t("<img>").attr("src", "https://d3e54v103j8qbb.cloudfront.net/img/webflow-badge-text-d2.c82cec3b78.svg").attr("alt", "Made in Webflow"),
                    n.append(i, a),
                    n[0]),
                    d(),
                    setTimeout(d, 500),
                    ...
                    e = function(e) {
                        ...
                        t.ajax({
                            ...
                            function(e) {
                                ...
                                r = (i = e.scriptPath).indexOf("//") >= 0 ? i : h("https://editor-api.webflow.com" + i),
                                o = function() {
                                ...
                                !function(t) {
                                    ...
                                    t.addEventListener("focus", function(t) {
                                        if (o(t.target)) {
                                            var n, i, s;
                                            (e || (i = (n = t.target).type,
                                            "INPUT" === (s = n.tagName) && r[i] && !n.readOnly || "TEXTAREA" === s && !n.readOnly || n.isContentEditable || 0)) && a(t.target)
                                        }
                                    }, !0),
        ...
        334: function(t, e, n) {
            ...
            i.define("focus", t.exports = function() {
                ...
                function r(n) {
                    ...
                    (/^a$/i.test(r) && null != i.href || /^(button|textarea)$/i.test(r) && !0 !== i.disabled || /^input$/i.test(r) && /^(button|reset|submit|radio|checkbox)$/i.test(i.type) && !i.disabled || !/^(button|input|textarea|select|a)$/i.test(r) && !Number.isNaN(Number.parseFloat(i.tabIndex)) || /^audio$/i.test(r) || /^video$/i.test(r) && !0 === i.controls) && (e = !0,
                    setTimeout( () => {
                        for (e = !1,
                        ...
                        !function(e) {
                            if (!e.getAttribute("hreflang")) {
                                ...
                                !(i.indexOf(":") >= 0)) {
                                    ...
                                    "#" !== i && "" !== i && v(a, d, l.href === c.href || i === o || f.test(i) && h.test(o))
                                }
                            }
                        }(e[a]);
                ...
                function w(e) {
                    ...
                    if (!(i.env("design") || window.$.mobile && /(?:^|\s)ui-link(?:$|\s)/.test(a.className))) {
                        ...
                        if ("" !== c) {
                            ...
                            e.stopPropagation()),
                            d = c,
                            n.hash !== d && r && r.pushState && !(i.env.chrome && "file:" === n.protocol) && (r.state && r.state.hash) !== d && r.pushState({
                                hash: d
                            }, "", d),
                                    ...
                                    if (i !== r) {
                                        var a = function(t, e, n) {
                                          ...
                                          , d = function() {
                                            ...
                                            window.scroll(0, (t = i,
                                            e = r,
                                            (o = f) > (s = a) ? e : t + (e - t) * ((l = o / s) < .5 ? 4 * l * l * l : (l - 1) * (2 * l - 2) * (2 * l - 2) + 1))),
                ...
                function i(e) {
                    ...
                    function c(e) {
                        if (o) {
                            ...
                            var i, u, c, l, f = e.touches, h = f ? f[0].clientX : e.clientX, p = h - r;
                            r = h,
                            Math.abs(p) > s && n && "" === String(n()) && (i = "swipe",
                            u = e,
                            c = {
        ...
        655: function(t, e, n) {
            ...
            i.define("navbar", t.exports = function(t, e) {
                ...
                function L(n, i) {
                    var r, a, c, l, h, p = t(i), m = t.data(i, v);
                    m || (m = t.data(i, v, {
                        open: !1,
                        el: p,
                        config: {},
                    ...
                    m.outside = ((r = m).outside && f.off("click" + v, r.outside),
                    function(e) {
                        var n = t(e.target);
                        u && n.closest(".w-editor-bem-EditorOverlay").length || $(r, n)
                    }
                    );
                    var w = p.find(".w-nav-brand");
                    w && "/" === w.attr("href") && null == w.attr("aria-label") && w.attr("aria-label", "home"),
                    ...
                    function(t, n) {
                        ...
                        !0 === n.open && P(a, !0),
                        !1 === n.open && j(a, !0),
                        a.open && e.defer(function() {
                            i !== d.width() && R(a)
                        })
                    }
                    ))) : ((c = m).overlay || (c.overlay = t('<div class="w-nav-overlay" data-wf-ignore />').appendTo(c.el),
                    c.overlay.attr("id", c.overlayContainerId),
                    c.parent = c.menu.parent(),
                    j(c, !0)),
                    m.button.on("click" + v, I(m)),
                    m.menu.on("click" + v, "a", z(m)),
                    m.button.on("keydown" + v, (l = m,
                    function(t) {
                        switch (t.keyCode) {
                        case o.SPACE:
                        case o.ENTER:
                        ...
                        case o.END:
                            if (!l.open)
                                ...
                                t.stopPropagation();
                            return t.keyCode === o.END ? l.selectedIdx = l.links.length - 1 : l.selectedIdx = 0,
                            C(l),
                            t.preventDefault(),
                            t.stopPropagation()
                        }
                    ...
                    function(t) {
                        if (h.open)
                            ...
                            case o.HOME:
                            case o.END:
                                return t.keyCode === o.END ? h.selectedIdx = h.links.length - 1 : h.selectedIdx = 0,
                                C(h),
                                t.preventDefault(),
                                t.stopPropagation();
                            case o.ESCAPE:
                ...
                function N(e, n) {
                    ...
                    if (!i.open || r || s || j(i, !0),
                    i.container.length) {
                        var o, a = ("none" === (o = i.container.css(D)) && (o = ""),
                        function(e, n) {
                            (n = t(n)).css(D, ""),
                ...
                function j(t, e) {
                    if (t.open) {
                        ...
                        var i = "transform " + n.duration + "ms " + n.easing2
                          ...
                          , a = t.el.height();
                        if (n.animOver)
                            return void l(t.menu).add(i).start({
                                x: o * n.animDirect
                            }).then(s);
